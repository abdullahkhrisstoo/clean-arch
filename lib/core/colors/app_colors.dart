...
class AppColors {
  ...
  static const Color lightBackGround = Color.fromARGB(255, 246, 250, 255);
  ...
  static const Color primaryColor = Color.fromARGB(255, 19, 78, 120);
  static const Color secondaryColor = Color.fromARGB(255, 159, 202,
      255); //todo: using for all icon or backGroung icon in the app
...
class ScaffoldColor {
  ...
  static const Color lightBackGroundColor = Color.fromARGB(255, 241, 240, 240);
}
